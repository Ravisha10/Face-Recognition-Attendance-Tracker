...
window = tk.Tk()
window.title("FRAT-Face Recognition Attendance Tracker")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="black", bg="palevioletred3",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="black", bg="palevioletred3",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/neela/Desktop/Face-Recognition-Attendance-Tracker/Face-Recognition-Attendance-Tracker/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                   r'explorer /select,"C:\Users\neela\Desktop\Face-Recognition-Attendance-Tracker\Face-Recognition-Attendance-Tracker\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/neela/Desktop/Face-Recognition-Attendance-Tracker/Face-Recognition-Attendance-Tracker/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
           r'explorer /select,"C:\Users\neela\Desktop\Face-Recognition-Attendance-Tracker\Face-Recognition-Attendance-Tracker\Attendance\-------Check atttendance-------"')
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'ravisha':
            if password == 'ravisha123':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
                root.title("Student Details")
                root.configure(background='palevioletred3')

                cs = 'C:/Users/neela/Desktop/Face-Recognition-Attendance-Tracker/Face-Recognition-Attendance-Tracker/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    un = tk.Label(win, text="Enter username : ", width=15, height=2, fg="black", bg="palevioletred3",
                  font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="Enter password : ", width=15, height=2, fg="black", bg="palevioletred3",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
...
message = tk.Label(window, text="Face Recognition Attendance Tracker", bg="black", fg="white", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment : ", width=20, height=2,
               fg="black", bg="palevioletred3", font=('times', 15, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="black",
                bg="palevioletred3", height=2, font=('times', 15, ' bold '))
